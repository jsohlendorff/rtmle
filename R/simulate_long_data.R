...
simulate_long_data <- function(n,
    ...
    beta_init <- list(A0_on_A = 0,A0_on_Y = 0,A0_on_D = 0,A0_on_C = 0,sum_A_on_Y = 0,age_on_Y = 0,age_on_D = 0,age_on_C = 0,age_on_A = 0,age_on_L = 0,sex_on_Y = 0,sex_on_D = 0,sex_on_C = 0,sex_on_A = 0,sex_on_L = 0,L0_on_A = 0,L0_on_Y = 0,L0_on_D = 0,L0_on_C = 0,sum_L_on_Y = 0)
    if (missing(beta)) {
        Beta <- beta_init
    } else {
